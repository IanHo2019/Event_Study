...
* Splines of length 2
constraint define 10 D_pre9-D_pre8 = D_pre8-D_pre7
constraint define 11 D_pre7-D_pre6 = D_pre6-D_pre5
constraint define 12 D_pre5-D_pre4 = D_pre4-D_pre3
constraint define 13 D_pre3-D_pre2 = D_pre2-D_pre1
constraint define 14 D_post0-D_post1 = D_post1-D_post2
constraint define 15 D_post2-D_post3 = D_post3-D_post4
constraint define 16 D_post4-D_post5 = D_post5-D_post6
constraint define 17 D_post6-D_post7 = D_post7-D_post8

* Splines of length 3
constraint define 21 D_pre10-D_pre9 = D_pre9-D_pre8
constraint define 22 D_pre9-D_pre8 = D_pre8-D_pre7

constraint define 23 D_pre7-D_pre6 = D_pre6-D_pre5
constraint define 24 D_pre6-D_pre5 = D_pre5-D_pre4

constraint define 25 D_pre4-D_pre3 = D_pre3- D_pre2
constraint define 26 D_pre3-D_pre2 = D_pre2-D_pre1

constraint define 27 D_post0-D_post1 = D_post1-D_post2

constraint define 28 D_post2-D_post3 = D_post3-D_post4
constraint define 29 D_post3-D_post4 = D_post4-D_post5

constraint define 30 D_post5-D_post6 = D_post6-D_post7
constraint define 31 D_post6-D_post7 = D_post7-D_post8
constraint define 32 D_post7-D_post8 = D_post8-D_post9

* Pre- and post-event coefficients connected
constraint define 33 D_pre1-D_post0 = D_post0-D_post1
...
forvalues i = 1/4 {
	...
	if `i' == 2 {
		local panel = "2) Splines of length 2"
		local constr = "10/17"
		local j = 2
	}
	
	if `i' == 3 {
		local panel = "3) Splines of length 3"
		local constr = "21/32"
		local j = 3
	}
	
	if `i' == 4 {
		local panel = "4) Splines of length 2, connected pre & post"
		local constr = "10/17 33"
		local j = 4
	}
